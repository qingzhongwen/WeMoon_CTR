...
from DeepRecall.layers.core import LocalActivationUnit
from DeepRecall.layers.normalization import LayerNormalization

if tf.__version__ >= '2.0.0':
    from DeepRecall.contrib.rnn_v2 import dynamic_rnn
else:
    from DeepRecall.contrib.rnn import dynamic_rnn
from DeepRecall.contrib.utils import QAAttGRUCell, VecAttGRUCell
