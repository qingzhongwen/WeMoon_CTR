import math
from DeepRecall.tools.utils import  input_from_feature_columns, build_input_features, combined_dnn_input, SparseFeat
from DeepRecall.layers.core import DNN
