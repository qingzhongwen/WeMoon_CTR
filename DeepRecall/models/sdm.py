...
from DeepRecall.tools.utils  import build_input_features, SparseFeat, DenseFeat, get_varlen_pooling_list, VarLenSparseFeat, \
    create_embedding_matrix, embedding_lookup, varlen_embedding_lookup, concat_func, get_item_embedding
from DeepRecall.layers.utils import NoMask
from tensorflow.python.keras.layers import Dense, Input, Lambda
from tensorflow.python.keras.models import Model

from DeepRecall.layers.core import PoolingLayer, SampledSoftmaxLayer, EmbeddingIndex
from DeepRecall.layers.interaction import UserAttention, SelfMultiHeadAttention, AttentionSequencePoolingLayer
from DeepRecall.layers.sequence import DynamicMultiRNN
